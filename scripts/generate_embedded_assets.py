...
index_path = Path(__file__).parent / "../app/www/index.html"
asset_dir = Path(__file__).parent / "../app/www/assets"
embedded_path = Path(__file__).parent / "../app/embedded_assets.cpp"
...
INCBIN(index_html, "../app/www/index.html");
INCBIN(main_js, "../app/www/assets/{js_filename}");
''')
