...
void init_database(shared_ptr<sqlite3> db) {
...
void start_server() {
    ...
    svr.Get("/api/pets", [dbptr](const Request& req, Response& res) {
        std::string query = R"(
    ...
    svr.Get("/api/pets/(\\d+)", [dbptr](const Request& req, Response& res) {
    ...
    // Get all categories
    svr.Get("/api/categories", [dbptr](const Request& req, Response& res) {
        sqlite3_stmt* stmt;
    ...
    // Create new order
    svr.Post("/api/orders", [dbptr](const Request& req, Response& res) {
    ...
    svr.Get("/api/orders", [dbptr](const Request& req, Response& res) {
        sqlite3_stmt* stmt;
